        ...
        <Toolbar>
          ...
          <Box style={{ width: '100%', }}>
            ...
            >
              ...
              <Box style={{ textAlign: 'center' }}>
                <NavLink exact to="/studentevaluation/aoJEwJOPSVr5XSAVve3L" style={isActive => ({
                  color: isActive ? "#26CE8D" : "#fff",
                  textDecoration: 'none'
                })}>
          ...
          <AccountCircleOutlinedIcon onClick={() => setOpen(open => !open)}
          ...
          <Box
            ...
            <Box style={{ textAlign: 'center', marginTop: 20, paddingRight: 30, paddingLeft: 30, }}>
              ...
              {authenticated ? (<Typography style={{
                color: "#7C7E83", float: "right", marginRight: 50,
                fontSize: 14
              }}>Signed in as {state.logAs}</Typography>) : (<div></div>)}
              {authenticated ? (
                <><LogoutIcon style={{
                  ...
                  <Typography style={{ color: '#B6B6B5', fontSize: 14, marginTop: 10 }}>
